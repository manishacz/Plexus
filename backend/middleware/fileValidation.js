...
// Define constants locally or import from a new ESM config if available.
// For now, mirroring values to avoid dependency on the CJS config file.
...
const checkFileOwnership = async (req, res, next) => {
    try {
        ...
        // Assuming Upload model is default export
